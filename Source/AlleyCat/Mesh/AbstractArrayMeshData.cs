...
{
    public abstract class AbstractArrayMeshData<TVertex> : AbstractMeshData<TVertex> where TVertex : IVertex
    {
        ...
        protected AbstractArrayMeshData(string key, Array source, uint formatMask) : base(key)
        {
